...
ما نوع البيانات التي تريد تحليلها؟`,
      ...
      performance: {
        text: `مرحباً! أنا مدير الأداء والأمان. سأساعدك في:

🔒 **الأمان**: مراقبة الوصول الآمن والحماية
⚡ **الأداء**: تحسين سرعة النظام واستهلاك الموارد
💾 **إدارة الذاكرة**: تنظيف البيانات المنتهية الصلاحية
📊 **المراقبة**: تتبع حالة النظام وزمن الاستجابة

هل تحتاج تحليل أداء النظام أم مراجعة إعدادات الأمان؟`,
        actionButton: {
          label: 'فحص الأداء والأمان',
