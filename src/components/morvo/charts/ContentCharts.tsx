...
const contentPerformanceData = [
  { month: 'يناير', views: 15000, engagement: 12.5 },
  { month: 'فبراير', views: 18500, engagement: 14.2 },
  { month: 'مارس', views: 22000, engagement: 16.8 },
  { month: 'أبريل', views: 25500, engagement: 18.5 },
  { month: 'مايو', views: 28000, engagement: 20.1 },
  { month: 'يونيو', views: 32000, engagement: 22.7 }
];

const topArticlesData = [
  { title: 'دليل التسويق الرقمي', reads: 5200 },
  { title: 'استراتيجيات السوشيال ميديا', reads: 4800 },
  { title: 'تحسين محركات البحث', reads: 4200 },
  { title: 'التسويق بالمحتوى', reads: 3900 },
  { title: 'إعلانات جوجل', reads: 3500 }
];

const contentTypesData = [
  { type: 'مقالات', value: 40, color: '#3b82f6' },
  { type: 'فيديوهات', value: 25, color: '#ef4444' },
  { type: 'إنفوجرافيك', value: 20, color: '#10b981' },
  { type: 'بودكاست', value: 15, color: '#f59e0b' }
];

const contentLengthEngagementData = [
  { length: 500, engagement: 8.2, title: 'مقال قصير' },
  { length: 1200, engagement: 15.5, title: 'مقال متوسط' },
  { length: 2000, engagement: 22.8, title: 'مقال طويل' },
  { length: 800, engagement: 12.1, title: 'مقال قصير' },
  { length: 1500, engagement: 18.9, title: 'مقال متوسط' },
  { length: 2500, engagement: 25.3, title: 'مقال مفصل' }
];

const contentQualityData = [
  { metric: 'الأصالة', score: 85 },
  { metric: 'العمق', score: 78 },
  { metric: 'الجاذبية', score: 92 },
  { metric: 'الوضوح', score: 88 },
  { metric: 'القيمة المضافة', score: 90 },
  { metric: 'سهولة القراءة', score: 82 }
];
